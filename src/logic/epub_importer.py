...
class EpubImporter(QObject):
    ...
    def import_epub(self, epub_path: str) -> None:
        """
        ...
        try:
            ...
            with zipfile.ZipFile(epub_path, 'r') as epub_zip:
                ...
                self._convert_chapters_to_txt(chapters, output_dir)
    ...
    def _extract_metadata(self, epub_zip: zipfile.ZipFile) -> Optional[Dict]:
        ...
        try:
            ...
            opf_path = container_root.find('.//container:rootfile', self.namespaces).get('full-path')
    ...
    def _convert_chapters_to_txt(self, chapters: List[Dict], output_dir: str) -> None:
        ...
        for chapter in chapters:
            try:
                ...
                # Añadir título del capítulo si se encontró uno
                ...
                if chapter_title and not text.startswith(chapter_title):
                    ...
                    text = f"Capítulo {chapter['number']}\n\n{text}"
    ...
    def _extract_structured_text(self, soup: BeautifulSoup) -> str:
        ...
        for element in main_content.find_all(['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p', 'div', 'blockquote', 'li']):
